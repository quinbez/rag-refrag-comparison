...
class Retriever:
    ...
    """
    def __init__(self, docs: Union[List[Dict], List[str]], doc_texts: List[str] = None, embedding_model: str = "all-MiniLM-L6-v2"):
        self.docs = docs
        ...
        self.embeddings = self.embedder.encode(texts_to_embed, convert_to_tensor=True).cpu().numpy()
    ...
    def search(self, query: str, k: int = 3) -> List[Union[Dict, str]]:
        """
        ...
        Returns:
            List[str]: List of top-k retrieved documents or strings.
        """
